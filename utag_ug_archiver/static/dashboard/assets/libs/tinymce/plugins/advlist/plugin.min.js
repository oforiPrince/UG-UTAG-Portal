    ...
    var n, e, t, r = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        ...
        y = function(o, n, e, t, r, i) {
            o.ui.registry.addSplitButton(n, {
                ...
                select: function(e) {
                    var n, t, r;
                    return (t = (n = o).dom.getParent(n.selection.getNode(), "ol,ul"), r = n.dom.getStyle(t, "listStyleType"), d(r)).map(function(n) {
                        return e === n
                    }).getOr(!1)
                },
                onSetup: function(e) {
        ...
        v = function(n, e, t, r, o, i) {
            var u, l, c, s, a;
            1 < i.length ? y(n, e, t, r, o, i) : (l = e, c = t, s = r, a = o, (u = n).ui.registry.addToggleButton(l, {
                active: !1,
                tooltip: c,
