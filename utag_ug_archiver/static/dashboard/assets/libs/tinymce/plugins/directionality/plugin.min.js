...
! function() {
    ...
    var n, t, e, o, r = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        ...
        v = ("undefined" != typeof window || Function("return this;")(), function(t) {
            return function(n) {
        ...
        T = v(9),
        N = v(11),
        D = g(Element.prototype.attachShadow) && g(Node.prototype.getRootNode) ? function(n) {
        ...
        C = function(n) {
            ...
            return w(y.fromDom(t)).fold(function() {
