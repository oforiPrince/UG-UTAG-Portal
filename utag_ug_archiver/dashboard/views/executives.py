...
class OfficerDeleteView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        # Remove executive-specific fields
        officer.executive_position = None
        officer.fb_profile_url = None
        officer.twitter_profile_url = None
        officer.linkedin_profile_url = None
        officer.date_appointed = None
        officer.date_ended = None
